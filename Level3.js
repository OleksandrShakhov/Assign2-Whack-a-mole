...
const WhackAMole = ({ onGoHome }) => {
    ...
    const startGame = () => {
        setMoles([
            ...
            { id: 9, color: getRandomMoleColor() },
            { id: 10, color: getRandomMoleColor() },
            { id: 11, color: getRandomMoleColor() },
        ]);
        setScore(0);
        setLives(3);
        setTimeLeft(20);
    ...
    const getRandomMoleColor = () => {
        // Approximately 60% green and 40% black
            ...
            setInterval(() => {
                ...
                setMoles((prevMoles) => {
                    ...
                    if (newMoles[randomIndex].color === 'green') {
                        // If a green mole is missed, reduce a life by one
